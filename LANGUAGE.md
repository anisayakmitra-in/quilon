...
it the binary carries none. Line tables and per-function scopes only —
local-variable and full-type debug info is a later addition. Debug info is
attributed to the program's own source file; functions
